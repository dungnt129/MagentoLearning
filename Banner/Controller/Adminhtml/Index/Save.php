...
use Thangnt\Banner\Model\Banner;
...
class Save extends Action
{
     ...
     */
    const ADMIN_RESOURCE = 'Thangnt_Banner::save';
...
//            echo "<pre>"; var_dump($data['images']); echo "</pre>"; die;
            ...
            $model = $this->_objectManager->create('Thangnt\Banner\Model\Banner');
