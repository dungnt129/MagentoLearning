...
class Topmenu extends \Magento\Theme\Block\Html\Topmenu
{
    ...
    protected function _getHtml(
        ...
        foreach ($children as $child) {
            ...
            $html .= '<li ' . $this->_getRenderedMenuItemAttributes($child) . '><div class="'.(($child->getDataByKey('color_category')) ? $child->getDataByKey('color_category'). ' parent_category' : 'pc5-nav-sm-' .($childLevel +1)).'">';
    ...
    protected function _addSubMenu($child, $childLevel, $childrenWrapClass, $limit)
    {
        ...
        $html .= '<ul class="level' . $childLevel . ' submenu pc5-nav-tgl-'.($childLevel +2).'" style="display:none">';
