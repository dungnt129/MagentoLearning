...
namespace Cowell\Banner\Controller\Adminhtml\Index;
...
class Edit extends \Magento\Backend\App\Action
{
     ...
     */
    const ADMIN_RESOURCE = 'Cowell_Banner::save';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Cowell_Banner::banner');
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Cowell\Banner\Model\Banner');
