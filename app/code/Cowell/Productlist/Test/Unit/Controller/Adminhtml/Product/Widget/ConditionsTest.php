...
namespace Magento\Productlist\Test\Unit\Controller\Adminhtml\Product\Widget;
...
{
    /**
     * @var \Magento\Productlist\Controller\Adminhtml\Product\Widget\Conditions
     */
    protected $controller;

    /**
     * @var \Cowell\Productlist\Model\Rule|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $rule;
    ...
    {
        $this->rule = $this->getMock('Cowell\Productlist\Model\Rule', [], [], '', false);
        ...
        $arguments = $objectManagerHelper->getConstructArguments(
            'Magento\Productlist\Controller\Adminhtml\Product\Widget\Conditions',
            [
                'rule' => $this->rule,
    ...
    {
        $type = 'Cowell\Productlist\Model\Rule\Condition\Product|attribute_set_id';
        ...
        $condition = $this->getMockBuilder('Cowell\Productlist\Model\Rule\Condition\Product')
            ->setMethods([
                'setId',
                'setType',
                'setRule',
        ...
        $condition->expects($this->once())->method('setType')
            ->with('Cowell\Productlist\Model\Rule\Condition\Product')
