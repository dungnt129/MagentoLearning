...
namespace Ibis\Banner\Controller\Adminhtml\Index;
...
class Edit extends \Magento\Backend\App\Action
{
     ...
     */
    const ADMIN_RESOURCE = 'Ibis_Banner::save';
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Ibis_Banner::banner');
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Ibis\Banner\Model\Banner');
